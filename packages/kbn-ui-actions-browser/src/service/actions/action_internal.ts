...
import { type FC, createElement as h, useRef, useLayoutEffect, useMemo } from 'react';
import { Action, ActionContext as Context, ActionDefinition, ActionMenuItemProps } from './action';
import type { Presentable, PresentableGrouping } from '../types/presentable';
import {UiComponent, UiComponentInstance} from '../types/ui_component';
  ...
  implements Action<Context<A>>, Presentable<Context<A>>
{
  ...
  public readonly ReactMenuItem?: FC<ActionMenuItemProps<Context<A>>>;
