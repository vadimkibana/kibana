...
> {
  ...
  public visitColumn(
    parent: VisitorContext | null,
    node: ESQLColumn,
    input: VisitorInput<Methods, 'visitColumnExpression'>
  ): VisitorOutput<Methods, 'visitColumnExpression'> {
    this.assertMethodExists('visitColumnExpression');

    const context = new ColumnExpressionVisitorContext(this, node, parent);
    const output = this.methods.visitColumnExpression!(context, input);
  ...
  public visitSource(
    parent: VisitorContext | null,
    node: ESQLSource,
    input: VisitorInput<Methods, 'visitSourceExpression'>
  ): VisitorOutput<Methods, 'visitSourceExpression'> {
    this.assertMethodExists('visitSourceExpression');

    const context = new SourceExpressionVisitorContext(this, node, parent);
    const output = this.methods.visitSourceExpression!(context, input);
  ...
  public visitListLiteralExpression(
    parent: VisitorContext | null,
    node: ESQLList,
    input: VisitorInput<Methods, 'visitListLiteralExpression'>
  ): VisitorOutput<Methods, 'visitListLiteralExpression'> {
    this.assertMethodExists('visitListLiteralExpression');

    const context = new ListLiteralExpressionVisitorContext(this, node, parent);
    const output = this.methods.visitListLiteralExpression!(context, input);
  ...
  public visitTimeIntervalLiteralExpression(
    ...
    input: VisitorInput<Methods, 'visitTimeIntervalLiteralExpression'>
  ): VisitorOutput<Methods, 'visitTimeIntervalLiteralExpression'> {
    this.assertMethodExists('visitTimeIntervalLiteralExpression');

    const context = new TimeIntervalLiteralExpressionVisitorContext(this, node, parent);
    const output = this.methods.visitTimeIntervalLiteralExpression!(context, input);
  ...
  public visitInlineCastExpression(
    parent: VisitorContext | null,
    node: ESQLInlineCast,
    input: VisitorInput<Methods, 'visitInlineCastExpression'>
  ): VisitorOutput<Methods, 'visitInlineCastExpression'> {
    this.assertMethodExists('visitInlineCastExpression');

    const context = new InlineCastExpressionVisitorContext(this, node, parent);
    const output = this.methods.visitInlineCastExpression!(context, input);
